      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="inputGroup">
          <fieldset>
            ...
            <label>
              ...
              {language === 'en' ? en.TEXT_FAV_LANG_JS : esp.TEXT_FAV_LANG_JS}
            </label>
            <label>
              <input onChange={onChange} type="radio" name="favLanguage" value="rust" checked={values.favLanguage == 'rust'} />
              {language === 'en' ? en.TEXT_FAV_LANG_RUST : esp.TEXT_FAV_LANG_RUST}
            </label>
          </fieldset>
        ...
        <div className="inputGroup">
          ...
          <select id="favFood" name="favFood" value={values.favFood} onChange={onChange}>
            ...
            <option value="pizza">{language === 'en' ? en.TEXT_OPT_FAV_FOOD_2 : esp.TEXT_OPT_FAV_FOOD_2}</option>
